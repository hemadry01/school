                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="guardian_name" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- End row -->
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <h5>Father Name </h5>
                                          <div class="controls">
                                              <input type="text" name="father_name" class="form-control"> <div class="help-block"></div></div>
                                        </div><!-- End Col md-6 -->
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          <h5>Mother Name </h5>
                                          <div class="controls">
                                              <input type="text" name="mother_name" class="form-control" > <div class="help-block"></div></div>
                                        </div>
                                    </div><!-- End Col md-6 -->
                                </div> <!-- End row -->
                                <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="father_profession" class="form-control" > <div class="help-block"></div></div>
                                      </div>
                                  </div><!-- End Col md-6 -->
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="mother_profession" class="form-control" > <div class="help-block"></div></div>
                                      </div>
                                  </div><!-- End Col md-6 -->
                                </div> <!-- End row -->
