        ...
        <div class="row">
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h5 class="box-title">Add Teacher Information</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="designation" class="form-control" required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
                                            </div>
                                        </div>
                                    </div><!-- End Col md-6 -->
                                </div><!--End row -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="controls">
                                              <input type="date" name="dob" class="form-control"> <div class="help-block"></div></div>
                                        </div>
                                    </div><!-- End Col md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="controls">
                                              <input type="date" name="joining_date" class="form-control"> <div class="help-block"></div></div>
                                        </div>
                                    </div><!-- End Col md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <h5>Photo</h5>
                                            <div class="controls">
                                                <input type="file" name="photo" class="form-control" > <div class="help-block"></div></div>
                                          </div>
                                    </div><!-- End Col md-6 -->
                                </div> <!-- End row -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="controls">
                                              <input type="text" name="user_name" class="form-control"> <div class="help-block"></div></div>
                                        </div>
                                    </div><!-- End Col md-6 -->
                                    <div class="col-md-6">
                                        <div class="form-group">
