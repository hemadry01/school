                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    ...
                    <div class="box box-inverse bg-img" style="background-image: url(../images/gallery/full/1.jpg);" data-overlay="2">
                        ...
                        <div class="box-body text-center pb-50">
                          <a href="#">
                            <img class="avatar avatar-xxl avatar-bordered" src="{{asset($teacher->photo)}}" alt="">
                          </a>
                          <h4 class="mt-2 mb-0"><a class="hover-primary text-white" href="#">{{$teacher->name}}</a></h4>
                          <span class="text-muted">{{$teacher->designation}}</span><br>
                          ...
                          <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b>Date of Birth</b> <a class="pull-right">{{$teacher->dob}}</a>
                            </li>
                            <li class="list-group-item">
                ...
                <div class="nav-tabs-custom box-profile">
                  ...
                  <div class="tab-content">
                   ...
                   <div class="active tab-pane" id="usertimeline">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">Joining Date: {{$teacher->joining_date}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-white">Religion : {{$teacher->religion}}</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">Email : {{$teacher->email}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-white">Address: {{$teacher->address}}</p>
                            </div>
...
{{--
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">User name : {{$teacher->user_name}}</p>
                            </div>
