                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    ...
                    <div class="box box-inverse bg-img" style="background-image: url(../images/gallery/full/1.jpg);" data-overlay="2">
                        ...
                        <div class="box-body text-center pb-50">
                          <a href="#">
                            <img class="avatar avatar-xxl avatar-bordered" src="{{asset($users->image)}}" alt="">
                          </a>
                          <h4 class="mt-2 mb-0"><a class="hover-primary text-white" href="#">{{$users->name}}</a></h4>
                          <span class="text-muted">{{$users->role}}</span><br>
                ...
                <div class="nav-tabs-custom box-profile">
                  ...
                  <div class="tab-content">
                   ...
                   <div class="active tab-pane" id="usertimeline">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">Joining Date: {{$users->joining_date}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-white">Religion : {{$users->religion}}</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">Email : {{$users->email}}</p>
                            </div>
                            <div class="col-md-6">
                                <p class="text-white">Address: {{$users->address}}</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="text-white">User name : {{$users->user_name}}</p>
                            </div>
